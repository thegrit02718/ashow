...
export default function CalendarBox (props: any) {
  ...
  const contractDay = props.contractDay;
  const moveinDay = props.moveinDay;
    ...
    <View>
      ...
      >
        <CalendarSelect
          ...
          setContractDay={props.setContractDay}
          moveinDay={moveinDay}
          setMoveinDay={props.setMoveinDay}
...
function CalendarSelect (props: any) {
  ...
  return (
    <View style={{flex:1, alignItems: 'center', justifyContent:'center', backgroundColor: 'white'}}>
      ...
      <View style={{width: '100%', height: 360, backgroundColor: '#fff', alignItems: 'center', borderRadius: 15}}>
        <Calendar
          style={{
            width: 350,
            height: 350,
          }}
          current={props.formattedDate}
          theme={{
            backgroundColor: '#fff',
      ...
      <View style={{padding:20, width: '100%', flexDirection: 'row', justifyContent: 'space-between'}}>
        <TouchableOpacity 
          onPress={()=>{
            setCheckNum(0);
            props.setContractDay(props.formattedDate);
            props.setMoveinDay(props.formattedDate);
          }}
        >
