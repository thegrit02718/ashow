...
export default function PyengSelectModal(props: any) {
  ...
  return (
    <View style={{ width: '100%', height:500, position: 'absolute', bottom:0, borderRadius: 20, backgroundColor: '#fff', padding: 16 }}>
      ...
      <ScrollView style={{flex:1}}>
        ...
        </View>
        {
          props.pyengInfo.map((item : any, index: any)=>{
            ...
            const ashowPriceCopy = item.priceDefaultHigh - item.discountHigh
            const discountCopy = item.ashowDiscountSum;
            ...
            return (
              ...
              >
                <View style={{width:'100%', height: 80, flexDirection:'row', justifyContent:'space-between', alignItems:'center'}}>
                  <View style={{flex:2, marginRight:10}}>
                    <Typography fontSize={20} marginBottom={7}>{item.pyengName}</Typography>
